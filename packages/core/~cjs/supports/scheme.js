...
exports.Scheme = exports.SchemeChild = void 0;
...
class SchemeChild {
    ...
    validate(input) {
        ...
        if (this._structure.type === "RegExp") {
            if (this.condition(!(this._structure.match && utilities_1.TextUtility.isStringable(input) && this._structure.match.test(String(input))))) {
        ...
        if (this._structure.type !== "RegExp") {
            if (this.condition(type !== (0, facades_1.revealType)(input))) {
        ...
        if (utilities_1.TextUtility.isStringable(type)) {
...
exports.SchemeChild = SchemeChild;
class Scheme {
    constructor(scheme) {
        this.scheme = scheme;
    }
