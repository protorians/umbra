...
exports.WalkableList = void 0;
const enums_1 = require("../enums");
const utilities_1 = require("../utilities");
var adjustNumber = utilities_1.NumberUtility.adjust;
class WalkableList {
    ...
    jump(index, type = enums_1.WalkableAction.Jump) {
        var _a;
    ...
    next() {
        return this.jump(this._index + 1, enums_1.WalkableAction.Next);
    }
    previous() {
        return this.jump(this._index - 1, enums_1.WalkableAction.Previous);
    }
    first() {
        return this.jump(0, enums_1.WalkableAction.First);
    }
    last() {
        return this.jump(this._list.length - 1, enums_1.WalkableAction.Last);
    }
}
exports.WalkableList = WalkableList;
