...
export type IDirective<I> = (payload: IDirectivePayload<I>) => I | TreatmentQueueStatus.Exit | TreatmentQueueStatus.Cancel | TreatmentQueueStatus.SnapOut | undefined | void;
